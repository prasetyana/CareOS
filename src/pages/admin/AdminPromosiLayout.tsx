...
import { Newspaper, Ticket, Megaphone, Star } from 'lucide-react';
import { useTenantParam } from '../../hooks/useTenantParam';

const promosiTabs = [
    { name: 'Banner Promo', href: 'banner-promo', icon: Newspaper },
    { name: 'Kode Diskon', href: 'kode-diskon', icon: Ticket },
    { name: 'Event & Campaign', href: 'event-campaign', icon: Megaphone },
    { name: 'Loyalti', href: 'loyalti', icon: Star },
];

const AdminPromosiLayout: React.FC = () => {
...
export default AdminPromosiLayout;
