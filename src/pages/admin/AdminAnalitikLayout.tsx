...
import { BarChart, Globe, Trophy } from 'lucide-react';
import { useTenantParam } from '../../hooks/useTenantParam';

const analitikTabs = [
    { name: 'Statistik Penjualan', href: 'statistik-penjualan', icon: BarChart },
    { name: 'Traffic Website', href: 'traffic-website', icon: Globe },
    { name: 'Menu Terlaris', href: 'menu-terlaris', icon: Trophy },
];

const AdminAnalitikLayout: React.FC = () => {
...
export default AdminAnalitikLayout;
