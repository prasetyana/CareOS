...
import { List, ClipboardList, History } from 'lucide-react';
import { useTenantParam } from '../../hooks/useTenantParam';

const pesananTabs = [
    { name: 'Semua Pesanan', href: 'semua-pesanan', icon: List },
    { name: 'Pesanan Aktif', href: 'pesanan-aktif', icon: ClipboardList },
    { name: 'Riwayat Pesanan', href: 'riwayat-pesanan', icon: History },
];

const AdminPesananLayout: React.FC = () => {
...
export default AdminPesananLayout;
