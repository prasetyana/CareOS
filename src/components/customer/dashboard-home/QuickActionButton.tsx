...
const QuickActionButton: React.FC<QuickActionButtonProps> = ({ to, onClick, icon: Icon, label, color = "text-brand-primary" }) => {
    const content = (
        <>
            ...
            <span className="text-[11px] sm:text-[12px] font-medium tracking-wide text-neutral-600 dark:text-neutral-300 text-center leading-tight line-clamp-2 group-hover:text-brand-primary transition-colors">
                {label}
            </span>
        </>
    );
