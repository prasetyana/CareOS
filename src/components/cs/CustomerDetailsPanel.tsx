...
import { Conversation, Order, User, fetchOrdersByCustomerId, mockUsers, fetchConversationsByCustomerId, KnowledgeBaseItem, fetchKnowledgeBase, CustomerActivity, fetchCustomerActivityByCustomerId } from '../../data/mockDB';
import { User as UserIcon, Mail, ShoppingBag, Star, Plus, X, BookText, Send, Monitor, Smartphone } from 'lucide-react';
...
const getLoyaltyTier = (points: number = 0) => {
    if (points >= 2000) return { name: 'Platinum', color: 'text-cyan-400' };
