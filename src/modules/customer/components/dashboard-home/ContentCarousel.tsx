        ...
        >
            ...
            {totalPages > 1 && (
                <>
                    <button
                        onClick={() => paginate(-1)}
                        className="absolute top-[38%] -translate-y-1/2 -left-4 z-10 p-2.5 bg-white/80 dark:bg-neutral-800/80 rounded-full text-text-primary backdrop-blur-md shadow-apple-md border border-white/20 dark:border-white/10 opacity-0 group-hover/carousel:opacity-100 transition-all duration-300 hover:scale-110 active:scale-95"
                    ...
                    <button
                        onClick={() => paginate(1)}
                        className="absolute top-[38%] -translate-y-1/2 -right-4 z-10 p-2.5 bg-white/80 dark:bg-neutral-800/80 rounded-full text-text-primary backdrop-blur-md shadow-apple-md border border-white/20 dark:border-white/10 opacity-0 group-hover/carousel:opacity-100 transition-all duration-300 hover:scale-110 active:scale-95"
                    ...
                    <div className="absolute bottom-2 right-4 flex gap-1.5 z-20">
                        {Array.from({ length: totalPages }).map((_, index) => (
                            <button
                                ...
                                className={`h-1.5 rounded-full transition-all duration-300 ${page === index ? 'w-6 bg-accent' : 'w-1.5 bg-neutral-300 dark:bg-neutral-600 hover:bg-neutral-400 dark:hover:bg-neutral-500'}`}
