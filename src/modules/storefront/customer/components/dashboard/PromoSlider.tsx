...
const PromoSlider: React.FC<PromoSliderProps> = ({ banners }) => {
    ...
    // Default to false since we don't have sidebar context here yet
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <Link
                            ...
                            className={`bg-white/95 text-gray-900 font-semibold rounded-full hover:bg-white hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 inline-flex items-center group/cta backdrop-blur-md pointer-events-auto border border-white/20 shadow-lg shadow-black/10 ${isRightPanelOpen
