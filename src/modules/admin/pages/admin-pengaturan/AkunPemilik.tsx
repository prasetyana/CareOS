...
import { getOwnerProfile, updateOwnerProfile, fetchActivityLogs, logActivity, updateUserPassword } from '@core/services/tenantService';
import { UserProfile, ActivityLog } from '../../../../core/types/tenant';
import { UAParser } from 'ua-parser-js';
import {
    User, Mail, Phone, Calendar, MapPin, Camera, Shield, Key, Lock,
    Activity, Save, X, Loader2, CheckCircle, Pencil, Eye, EyeOff,
    ChevronDown, Download, XCircle, Clock, Monitor, Globe
} from 'lucide-react';
