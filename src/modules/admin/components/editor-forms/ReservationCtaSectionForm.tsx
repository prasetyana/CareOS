...
interface ReservationCtaSectionFormProps {
  ...
  onSubmit: (data: Partial<ReservationCtaSectionProps>) => Promise<void>;
}

const ReservationCtaSectionForm: React.FC<ReservationCtaSectionFormProps> = ({ initialData, onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <label htmlFor="ctaButtonLink" className={labelClasses}>Link Tombol</label>
        <input type="text" name="ctaButtonLink" id="ctaButtonLink" value={formData.ctaButtonLink} onChange={handleChange} className={inputClasses} placeholder="/contact" />
      </div>
...
export default ReservationCtaSectionForm;
