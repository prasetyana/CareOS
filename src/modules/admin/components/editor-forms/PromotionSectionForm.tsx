...
interface PromotionSectionFormProps {
  ...
  onSubmit: (data: Partial<PromotionSectionProps>) => Promise<void>;
}

const PromotionSectionForm: React.FC<PromotionSectionFormProps> = ({ initialData, onSubmit }) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
       ...
       <div>
        ...
        <input type="text" name="ctaButtonLink" id="ctaButtonLink" value={formData.ctaButtonLink} onChange={handleChange} className={inputClasses} placeholder="/menu" />
      </div>
      <div>
...
export default PromotionSectionForm;
