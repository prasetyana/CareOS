...
interface FeaturedMenuSectionFormProps {
  ...
  onSubmit: (data: Partial<FeaturedMenuSectionProps>) => Promise<void>;
}

const FeaturedMenuSectionForm: React.FC<FeaturedMenuSectionFormProps> = ({ initialData, onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <p className="text-sm text-brand-secondary dark:text-gray-400 pt-2">
        Catatan: Item menu yang ditampilkan diambil secara otomatis dari 3 item pertama dalam daftar menu Anda.
      </p>
...
export default FeaturedMenuSectionForm;
